...
(function ($) {
  ...
  VLTJS.throttleScroll(function (type, scroll) {
    ...
    function _show_navbar() {
      navbarHideOnScroll
        .removeClass("vlt-on-scroll-hide")
        .addClass("vlt-on-scroll-show");
    }

    function _hide_navbar() {
      navbarHideOnScroll
        .removeClass("vlt-on-scroll-show")
        .addClass("vlt-on-scroll-hide");
    }
...
(function ($) {
  ...
  VLTJS.document.on(
    "click",
    ".vlt-quantity .plus, .vlt-quantity .minus",
    function () {
      var $this = $(this),
...
(function ($) {
  ...
  function portfolio_hover_effect() {
    $("#vlt-grid-portfolio-04").append(
      '<div class="js-caption"><h4></h4></div>'
    );
    ...
    $portfolioGrid.find(".vlt-portfolio-item-overlay").on({
      mouseenter: function () {
        ...
        $jsCaptionTitle.text(
          $(this).find(".vlt-portfolio-item-meta-title").text()
        );
      ...
      pagination: {
        ...
        renderBullet: function (index, className) {
          return (
            ...
            (index + 1) +
            " - " +
            render_max_slides($this.find(".swiper-slide").length) +
            "</span>"
          );
        },
      },
...
(function ($) {
  ...
  $(
    ".vlt-projects-showcase--style-4 .swiper-container, .vlt-projects-showcase--style-6 .swiper-container"
  ).each(function () {
    var $this = $(this),
...
(function ($) {
  ...
  function stretch_element_inside_column() {
    ...
    $(".row .vlt-stretch-element-inside-column").each(function () {
      ...
      const leftRow =
        rectRow.left + (parseFloat($row.css("padding-left")) || 0);
      const rightRow =
        wndW - rectRow.right + (parseFloat($row.css("padding-right")) || 0);
  ...
  $(".vlt-testimonial-slider--style-2 .swiper-container").each(function () {
    ...
    var testimonialSlider = new Swiper(this, {
      ...
      on: {
        init: function () {
          $(
            ".vlt-testimonial-slider .vlt-testimonial-item--style-2 .vlt-testimonial-item__content, .vlt-testimonial-slider .vlt-testimonial-item--style-3 .vlt-testimonial-item__content"
          ).matchHeight();
        },
      },
    });
